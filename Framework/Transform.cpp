#include "stdafx.h"
#include "Transform.h"
Transform::Transform(Vector2 position, float angle, Vector2 scale) : Component(), position(position), rotatingAngle(angle), scale(scale), positioningCenter(Vector2()), rotatingCenter(Vector2()), scalingCenter(Vector2()) {
