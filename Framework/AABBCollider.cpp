...
AABBCollider::AABBCollider(Transform& transform, const Vector2& size) : Collider(transform), boundingBox(size) {}

AABBCollider::AABBCollider(Transform& transform, float width, float height) : Collider(transform), boundingBox(width, height) {}

AABBCollider::AABBCollider(Transform& transform, const Vector2& leftTop, const Vector2& rightBottom) : Collider(transform), boundingBox(leftTop, rightBottom) {}

AABBCollider::AABBCollider(Transform& transform, float left, float top, float right, float bottom) : Collider(transform), boundingBox(left, top, right, bottom) {}
