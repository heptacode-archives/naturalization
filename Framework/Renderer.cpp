...
Renderer::Renderer() : Component(), currentSprite(nullptr), alpha(1.0f), initialized(false), width(0), height(0) {}

Renderer::Renderer(Sprite* startSprite, float alpha) : Component(), currentSprite(startSprite), alpha(alpha), initialized(true) {
	//Sprite Å©±â ¹Þ¾Æ¿È
